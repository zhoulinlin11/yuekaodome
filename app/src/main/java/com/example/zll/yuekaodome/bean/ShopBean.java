package com.example.zll.yuekaodome.bean;
...
public class ShopBean {
    ...
    public static class DataBean {
        ...
        private int sellerselect;
        private List<ListBean> list;

        public int getSellerselect() {
            return sellerselect;
        }

        public void setSellerselect(int sellerselect) {
